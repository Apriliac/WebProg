...
from avril.models import AccountUser, Course, AttendingCourse
from avril.signals import check_nim
from avril.forms import StudentRegisterForm
...
def deleteCourse(request):
    try:
        ...
        if user:
            ...
            return redirect('avril:read-data-course')
        else:
...
def createStudent(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('avril:read-data-student')
    else:
