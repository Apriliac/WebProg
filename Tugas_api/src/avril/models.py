...
class AccountUser(models.Model):
    ...
    account_user_fullname = models.CharField(max_length=255, null=False, editable=True)
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=['account_user_id', 'account_user_related_user'])]
...
class AttendingCourse(models.Model):
    ...
    def friendly_profile(self):
        return mark_safe(u"%s <%s>") % (
            ...
            escape(self.attending_course_created_by), escape(self.attending_course_created_date),
            escape(self.attending_course_updated_by), escape(self.attending_course_updated_date)
        )
